...
import { formatCompactPersianNumber } from '../../utils/formatters';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const commentsBadge =
    totalComments !== undefined && totalComments !== null
      ? formatCompactPersianNumber(totalComments)
      : '۰';
          ...
          <div className="h-18 px-6 border-b border-[#E69DB8]/15 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#7A6670] font-medium">پلتفرم هوشمند تحلیل داده</p>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    <Icon
                      ...
                      className={`transition-colors ${
                        isActive ? 'text-[#D88CA7]' : 'text-[#8A7580] group-hover:text-[#2D2327]'
                      }`}
                    />
          ...
          <div className="bg-[#F1E7E7]/60 rounded-xl p-3.5 border border-[#E69DB8]/20">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs font-semibold text-[#2D2327] truncate">وضعیت همگام‌سازی</div>
