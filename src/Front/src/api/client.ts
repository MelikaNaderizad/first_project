...
export function normalizeSeller(s: any): SellerItem {
  const satisfaction = Number(
    s.customer_satisfaction_score ?? s.satisfaction_score ?? 80,
  );
      ...
      categoryDistribution: Array.isArray(json.categoryDistribution)
        ...
        : [
            ...
            },
            {
              ...
              positive: 2850,
              negative: 250,
              positivePercentage: 91.9,
              negativePercentage: 8.1,
            },
            {
              ...
              positive: 1750,
              negative: 700,
              positivePercentage: 71.4,
              negativePercentage: 28.6,
            },
            {
              category: "مد و پوشاک",
              total: 1980,
      ...
      return {
        metrics: {
          ...
          avg_comments_per_product:
            total_comments > 0 ? Math.round(total_comments / 8) : 1466,
          change_rate: "+14.8%",
        },
    ...
    return {
      metrics: {
        total_comments: Number(
          json.metrics?.total_comments ?? rawComments.length,
        ),
        ...
        avg_comments_per_product: Number(
          json.metrics?.avg_comments_per_product ?? 1466,
        ),
    ...
    return {
      metrics: {
        ...
        avg_satisfaction_score: Number(
          json.metrics?.avg_satisfaction_score ?? 84.5,
        ),
